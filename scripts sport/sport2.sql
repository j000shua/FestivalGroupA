...
insert into Groupe (id, nom, nombrepersonnes, nompays, hebergement) values ('g002','Equipe de Rudby Rouen',25,'France','O');
...
insert into Groupe (id, nom, nombrepersonnes, nompays, hebergement) values ('g009','Equipe de basketball feminin de Perpignan',21,'France','O');
